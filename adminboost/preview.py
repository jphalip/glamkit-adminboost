    ...
    def render(self, name, data, attrs={}):
        ...
        if not self.form.preview_instance_required or self.instance is not None:
            ...
            for image in images:
                ...
                html += u'<div class="adminboost-preview-thumbnail"><a href="%(image_url)s" target="_blank"><img src="%(thumbnail_url)s"/></a></div>' % {'image_url': image_url, 'thumbnail_url': thumbnail.url}
